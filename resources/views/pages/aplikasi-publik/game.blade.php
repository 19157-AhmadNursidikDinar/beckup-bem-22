...
<head>
  ...
  <title>Arthasastra Game</title>
</head>

<body id="body">
  <div class="container">
    <div class="row">
      <img src="{{ url('frontend/assets/img/Arthasastra-Logo-Navbar.png') }}" class="logo-game">
    </div>
    ...
    <div class="tab-content" id="v-pills-tabContent">
      <div class="tab-pane fade show active" id="v-pills--1" role="tabpanel" aria-labelledby="v-pills-home-tab">
        <div class="row">
          <h1 class="greeting-mobile d-lg-none">Arthasastra Game</h1>
          <h3 class="tagline-mobile d-lg-none">Think one of the BEM members. <br>
          ...
          <div class="col-lg-6 d-flex align-items-start flex-column bd-highlight mb-3 home">
            ...
            <h5 class="desc">Arthasastra Game </h5>
            <h3 class="tagline">" Think one of the BEM members. <br>
            ...
            <div class="col-lg-7 text-center result">
              <div class="row pertanyaan position-relative">
                <h5 class="question" id="question">
                  Pikirkan salah satu pengurus BEM Fasilkom 2021. Jika sudah silahkan klik tombol <strong>MULAI</strong>
                </h5>
